    ...
    public class PopupDialogController
    {
        public class TimePickerFragment : AndroidX.Fragment.App.DialogFragment, TimePickerDialog.IOnTimeSetListener
        {
            ...
            public override Dialog OnCreateDialog(Bundle savedInstanceState)
            {
                ...
                TimePickerDialog dialog = new TimePickerDialog(Activity, AppSettings.SetTabDarkTheme ? Android.Resource.Style.ThemeDeviceDefaultDialogAlert : Android.Resource.Style.ThemeDeviceDefaultLightDialogAlert, this, currentTime.Hour, currentTime.Minute, is24HourFormat);
                return dialog;
            }
        ...
        public class DatePickerFragment : AndroidX.Fragment.App.DialogFragment, DatePickerDialog.IOnDateSetListener
        {
            ...
            public override Dialog OnCreateDialog(Bundle savedInstanceState)
            {
                ...
                DatePickerDialog dialog = new DatePickerDialog(Activity, AppSettings.SetTabDarkTheme ? Android.Resource.Style.ThemeDeviceDefaultDialogAlert : Android.Resource.Style.ThemeDeviceDefaultLightDialogAlert, this, currently.Year, currently.Month - 1, currently.Day);
                return dialog;
            }
